...
@section('main')
    <div class="page-content-wrapper">
      ...
      <div class="live-chat-intro mb-3">
        <p>Mulai Hubungi Admin</p><img src="{{ asset('img/bg-img/9.jpg')}}" alt="">
        <div class="status online">Kita online</div>
        ...
        <div class="container">
          ...
          <div class="live-chat-wrapper">
            ...
            <div class="agent-message-content d-flex align-items-start">
              <!-- Agent Thumbnail-->
              <div class="agent-thumbnail me-2 mt-2"><img src="{{ asset('img/bg-img/9.jpg')}}" alt=""></div>
              <!-- Agent Message Text-->
              <div class="agent-message-text">
                <div class="d-block">
                  <p>Hai ! You can start asking your question below. I am ready to help.</p>
                </div>
                <div class="d-block">
