        ...
        <div class="cart-wrapper-area py-3">
          <div class="cart-table card mb-3">
            <div class="table-responsive card-body">
              <table class="table mb-0">
                <tbody>
                  <tr>
                    <th scope="row"><a class="remove-product" href="/pembayaran/order-konfirm"><i class="lni lni-close"></i></a></th>
                  ...
                  <tr>
                    <th scope="row"><a class="remove-product" href="#"><i class="lni lni-close"></i></a></th>
                    <td><img class="rounded" src="img/product/10.png" alt=""></td>
          ...
          <div class="card cart-amount-area">
            <div class="card-body d-flex align-items-center justify-content-between">
              <h5 class="total-price mb-0">$<span class="counter">38.84</span></h5><a class="btn btn-warning" href="/pembayaran/order-konfirm">Checkout Now</a>
            </div>
          </div>
        </div>
      </div>
