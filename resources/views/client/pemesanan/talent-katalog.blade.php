              ...
              <div class="card horizontal-product-card">
                <div class="card-body d-flex align-items-center">
                  <div class="product-thumbnail-side">
                    <!-- Thumbnail -->
                    <a class="product-thumbnail d-block" href="/talent-detail"><img src="{{ asset('img/mobil/mobilio.jpg') }}" alt=""></a>
                  </div>
                  <div class="product-description">
                    <!-- Product Title --><a class="product-title d-block" href="/talent-detail">Tiara</a>
                    <!-- Price -->
                    ...
                    <!-- Buy Now Button --><a class="btn btn-success btn-sm" href="/talent-detail"></i>Detail Rental</a>
                  </div>
                </div>
              </div>
            </div>
