      ...
      <div class="top-products-area py-3">
        <div class="container">
          ...
          <div class="product-catagories">
            <div class="row g-3">
              <div class="col-4"><a class="shadow-sm" href="#"><img src="{{ asset('img/product/5.png') }}" alt="">Selesai</a></div>
              <div class="col-4"><a class="shadow-sm" href="#"><img src="{{ asset('img/product/9.png') }}" alt="">Divalidasi</a></div>
              <div class="col-4"><a class="shadow-sm" href="#"><img src="{{ asset('img/product/4.png') }}" alt="">Rental</a></div>
            </div>
          </div>
          <div class="row g-3">
